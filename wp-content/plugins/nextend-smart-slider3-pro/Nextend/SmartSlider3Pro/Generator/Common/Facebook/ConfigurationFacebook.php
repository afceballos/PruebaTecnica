...
class ConfigurationFacebook extends AbstractGeneratorGroupConfiguration {
    ...
    public function render($MVCHelper) {
        ...
        new OnOff($settings, 'manage_pages', n2_('manage pages'), 1, array(
            'tipLabel'       => n2_('Manage pages permission'),
            'tipDescription' => n2_('You need "manage_pages" permission if you want to access datas of Facebook pages, where you are an administrator. For other pages you still need to turn this option on, but request access to "Page Public Content Access" within your App.')
        ));
        new OnOff($settings, 'user_photos', n2_('user photos'), 1, array(
